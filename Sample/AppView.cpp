...
namespace HoloLensCppModules
{
	...
	void AppView::Initialize(Windows::ApplicationModel::Core::CoreApplicationView^ applicationView)
	{
		...
		m_main = std::make_unique<SampleMain>(m_deviceResources);
	}

	// Called when the CoreWindow object is created (or re-created).
	void AppView::SetWindow(Windows::UI::Core::CoreWindow^ window)
	{
		using Windows::Foundation::TypedEventHandler;
	...
	void AppView::OnViewActivated(Windows::ApplicationModel::Core::CoreApplicationView^ sender, Windows::ApplicationModel::Activation::IActivatedEventArgs^ args)
	{
		// Run() won't start until the CoreWindow is activated.
		sender->CoreWindow->Activate();
	}

	void AppView::OnSuspending(Platform::Object^ sender, Windows::ApplicationModel::SuspendingEventArgs^ args)
	{
	...
	void AppView::OnVisibilityChanged(Windows::UI::Core::CoreWindow^ sender, Windows::UI::Core::VisibilityChangedEventArgs^ args)
	{
		m_windowVisible = args->Visible;
	}

	void AppView::OnWindowClosed(Windows::UI::Core::CoreWindow^ sender, Windows::UI::Core::CoreWindowEventArgs^ args)
	{
		m_windowClosed = true;
	}
	...
	void AppView::OnKeyPressed(Windows::UI::Core::CoreWindow^ sender, Windows::UI::Core::KeyEventArgs^ args)
	{
		//
