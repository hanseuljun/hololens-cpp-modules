...
void SampleMain::SetHolographicSpace(HolographicSpace^ holographicSpace)
{
...
HolographicFrame^ SampleMain::Update()
{
...
void SampleMain::OnLocatabilityChanged(SpatialLocator^ sender, Object^ args)
{
